...
That's the session layer: the skills that manage continuity across a working session. Captain's log. Day planning. Context snapshots. Weekly resets. Reading list ingestion. These aren't task-layer utilities — they're the infrastructure that makes Claude a persistent collaborator rather than a stateless tool. The difference matters more than it sounds. Stateless tools get abandoned. Persistent collaborators become habits.
